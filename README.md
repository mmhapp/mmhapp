...
Integrating computer science (machine learning, data analysis, software engineering), mathematics (calculus, algebra, probability), and medicine (biosignals, computational drug discovery, neuroimaging).
